...
const TString InputDataFile = "/eos/user/z/zhenxuan/Hgg_mass/MiniTree/UL2018/MassUL2018_ETSS/NewDiphotonBDT_UL2018data.root";
...
const TString TreeNameData = "Data_13TeV_UntaggedTag";
//---
...
//const TString InputQCDFile = "New_DataDriven_QCD.root"; //wo min ID photon sigmaE/E reweighting
//const TString InputQCDFile = "New_DataDriven_QCD_sEoEWgt.root"; //SF + EC pT Weights + sigmaE/E weights
//const TString InputQCDFile = "New_DataDriven_QCD_OnlySF.root"; //SF
//const TString InputQCDFile = "New_DataDriven_QCD_NoPTWgt_sEoEWgt.root";//SF +  sigmaE/E weights
//const TString InputQCDFile = "New_DataDriven_QCD_2DpTWgt.root"; //SF + Tao 2D pT weights
//const TString InputQCDFile = "New_DataDriven_QCD_SF_2DpTWgt_sEoEWgt.root"; //SF + Tao 2D pT weights + sigmaE/E weights
// const TString InputQCDFile = "/eos/user/z/zhenxuan/Hgg_mass/MiniTree/UL2018/MassUL2018_ETSS/New_DataDriven_QCD_SFs_sEoEWgt_2DpTWgt.root";//SF + sigmaE/E weights + Tao 2D pT weights
// const TString InputQCDFile = "/eos/user/z/zhenxuan/Hgg_mass/MiniTree/UL2018/MassUL2018_ETSS/XGboost_diphoMVA_UL18_newSig.root";//SF + sigmaE/E weights + Tao 2D pT weights
...
const TString TreeNameQCD = "DataDriven_QCD";

// const string OutputPlotDir = "DataMCComparisonPlots_mvaCuts";
const string OutputPlotDir = "DataMCComparisonPlots_weightedDiphoBDT";
...
const string MCWeight = "weight*Norm_SFs"; // add a new weight to scale diphoton bdt score >-0.85

//VBF
///*
// const TString InputDataFile = "/eos/cms/store/user/jtao/MassInterference/CMSSW_10_6_8/VBFMiniTree/data2017_VBFMiniTree.root";
// const TString TreeNameData = "tagsDumper/trees/Data_13TeV_VBFTag";

// //const TString InputPPFile = "/eos/cms/store/user/jtao/MassInterference/CMSSW_10_6_8/VBFMiniTree/New_DiPhotonJetsBox_VBFMiniTree_WithSF.root";
// const TString InputPPFile = "/eos/cms/store/user/jtao/MassInterference/CMSSW_10_6_8/VBFMiniTree/New_DiPhotonJetsBox_VBFMiniTree_SFandVars.root";
// const TString TreeNamePP = "DiPhotonJetsBox_VBFMiniTree";

// //const TString InputQCDFile = "/eos/cms/store/user/jtao/MassInterference/CMSSW_10_6_8/VBFMiniTree/New_DataDrivenQCD_UL2017_VBFTag_WithSF.root";
// const TString InputQCDFile = "/eos/cms/store/user/jtao/MassInterference/CMSSW_10_6_8/VBFMiniTree/New_DataDrivenQCD_UL2017_VBFTag_SFandVars_sEoEWgt_2DpTWgt.root";
// const TString TreeNameQCD = "DataDrivenQCD_UL2017_VBFTag";

// //const string OutputPlotDir = "VBFDataMCComparisonPlots";
// //const string OutputPlotDir = "VBFDataMCComparisonPlotsBothEB";
// const string OutputPlotDir = "VBFDataMCComparisonPlotsNotEBEB";
// */
//====================
...
void DrawMyPlots(string Object, string Selections,  string XTitle, string YUnit, string PlotName, int BinTotal, double BinXLow, double BinXHig, int LegendLR=0, int IfLogY=0, int IfStatErr=0){
  ...
  c1->Clear();
  std::cout << "MCpp entries=" << h_MCpp->Integral() << std::endl;
  std::cout << "MCqcd entries=" << h_MCqcd->Integral() << std::endl;
  h_MCsig->SetLineColor(23);
  h_MCsig->SetFillColor(23);
  h_MCsig->SetFillStyle(3004);
  h_MCsig->SetLineStyle(1);
  h_MCsig->SetLineWidth(2);

  h_MCpp->SetLineColor(38);
  h_MCpp->SetFillColor(38);
  //h_MCpp->SetFillStyle(3004);
  h_MCpp->SetLineStyle(1);
  h_MCpp->SetLineWidth(2);

  h_MCqcd->SetLineColor(30);
  h_MCqcd->SetFillColor(30);
  ...
  legend->AddEntry(h_data,"Data","pe");
  legend->AddEntry(h_MCpp,"#gamma#gamma","f");
  legend->AddEntry(h_MCsig,"Sig #times 1000","f");
  legend->AddEntry(h_MCqcd,"Data-driven QCD","f");
  // if(IfStatErr==1) 
  ...
  */
  ...
  const TString PrintInfor2="59.8 fb^{-1} (13TeV)"; 
...
void DrawDataMCPlots(){
  ...
  return;
  DrawMyPlots("CMS_hgg_mass", Preselections, "m_{#gamma#gamma} (GeV)", "GeV", "DiphotonMass", 80, 100., 180., 0, 0);
