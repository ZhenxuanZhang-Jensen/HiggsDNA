...
class HHWW_Preselection_SL(Tagger):
    ...
    def calculate_selection(self, events):
        ...
        fatjet_H_cut = (fatjets.deepTagMD_HbbvsQCD<0.6)  & (fatjets.pt>300) & (fatjets.deepTagMD_H4qvsQCD>0.6)
        ...
        fatjet_W_cut = (fatjets.deepTagMD_HbbvsQCD<0.6) & (fatjets.pt>200) 
        ...
        events=events,
        name="fatjet_W",
        objects=fatjets_W[awkward.argsort(fatjets_W.msoftdrop - 80, ascending=True, axis=-1)],
        n_objects=1,
        dummy_value=-999
        ) # apply the inverse bb cuts
        ...
        presel_cut = (photon_id_cut)  & (category_cut) & (SL_cut)

        self.register_cuts(
            names=["Photon Selection"],
