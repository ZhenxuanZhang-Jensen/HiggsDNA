...
CONDA_TARFILE = "/eos/user/z/zhenxuan/hhwwgg_workspace/Higgsdna_condor_env/higgs-dna.tar.gz" # default conda tarfile area (so it doesn't get remade every time you run jobs. If you do install a new python package, simply remove the tarfile and it will be remade)
