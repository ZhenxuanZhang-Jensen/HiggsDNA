...
class CondorJob(Job):
    ...
    def write_condor_files(self):
        ...
        self.condor_exe_template = "/afs/cern.ch/user/z/zhenxuan/HiggsDNA/higgs_dna/job_management/condor/%s/exe_template.sh" % self.host
        self.condor_sub_template = "/afs/cern.ch/user/z/zhenxuan/HiggsDNA/higgs_dna/job_management/condor/%s/submit_template.txt" % self.host
