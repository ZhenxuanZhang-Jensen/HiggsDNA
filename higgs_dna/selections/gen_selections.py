...
def select_ww_to_qqlv_or_qqqq(events):
    ...
    # select W from Higgs
    gen_W_fromH = gen_part[numpy.logical_or((abs(gen_part.pdgId[gen_part.genPartIdxMother]) == 25), (abs(gen_part.pdgId[gen_part.genPartIdxMother]) == 35)) & (abs(gen_part.pdgId)==24)]    # choose the leading pt W
