...
def MakeTree(inputTree, h_ratio, scale, ouputFile):
 ...
 for i in range(0, nentries):
    ...
    # print("debug: 60")
    # MVA_Score_Branch="inputTree.%s"%("fathbbjet_deepTagMD_HbbvsQCD")
    MVA_Score_Branch = inputTree.fathbbjet_deepTagMD_HbbvsQCD
    exec("MVA_Score_Branch = inputTree.%s"%("fathbbjet_deepTagMD_HbbvsQCD"))
    # print("debug: 61")
 ...
 # for i in range(0, nentries):
    # inputTree.GetEntry(i)
    # if h_ratio.GetBinContent(h_ratio.FindBin(inputTree.fathbbjet_deepTagMD_HbbvsQCD))!=0.:
        # bdt_weight[0] = scale*float(h_ratio.GetBinContent(h_ratio.FindBin(inputTree.fathbbjet_deepTagMD_HbbvsQCD)))
    # else: bdt_weight[0] = scale
    # outTree.Fill()
 # outFile.cd()
 # outTree.Write()
...
def drawHistos(hist,hist_smooth,hist_smooth_up,hist_smooth_down,name):
   ...
   hist.GetXaxis().SetTitle('fathbbjet_deepTagMD_HbbvsQCD')
...
#  Cut_noMass = '( Leading_Photon_MVA>-0.7 && Subleading_Photon_MVA>-0.7 && fathbbjet_deepTagMD_HbbvsQCD>'+str(min)+' && EvalDNN_BBvsAll < 0.6 )'
 Cut_noMass = '( Leading_Photon_MVA>-0.7 && Subleading_Photon_MVA>-0.7 && fathbbjet_deepTagMD_HbbvsQCD>'+str(min)+' )'
#  Cut_SR = '( Leading_Photon_MVA>-0.7 && Subleading_Photon_MVA>-0.7 && CMS_hgg_mass>100. && CMS_hgg_mass<180. && (CMS_hgg_mass > '+str(massMin)+' && CMS_hgg_mass < '+str(massMax)+') && fathbbjet_deepTagMD_HbbvsQCD>'+str(min)+' && EvalDNN_BBvsAll < 0.6 )'
 Cut_SR = '( Leading_Photon_MVA>-0.7 && Subleading_Photon_MVA>-0.7 && CMS_hgg_mass>100. && CMS_hgg_mass<180. && (CMS_hgg_mass > '+str(massMin)+' && CMS_hgg_mass < '+str(massMax)+') && fathbbjet_deepTagMD_HbbvsQCD>'+str(min)+' )'
#  Cut_SB = '( Leading_Photon_MVA>-0.7 && Subleading_Photon_MVA>-0.7 && CMS_hgg_mass>100. && CMS_hgg_mass<180. && !(CMS_hgg_mass > 115 && CMS_hgg_mass < 135) && fathbbjet_deepTagMD_HbbvsQCD>'+str(min)+'&& EvalDNN_BBvsAll < 0.6  )'
 Cut_SB = '( Leading_Photon_MVA>-0.7 && Subleading_Photon_MVA>-0.7 && CMS_hgg_mass>100. && CMS_hgg_mass<180. && !(CMS_hgg_mass > 115 && CMS_hgg_mass < 135) && fathbbjet_deepTagMD_HbbvsQCD>'+str(min) + ')'
 ...
 xsbr="0.002629568*41.5"
 sig_tree_2017.AddFile(inDir+'/Signal_reweight.root/parquettree')
 sig_tree_2017.Draw("Leading_Photon_MVA<-1.?-1.1:Leading_Photon_MVA>>histo_scale","weight*"+xsbr+"*(Xmass==2000)*"+Cut_SR) # br_WW_qqqq = 0.4544, br_WW_qqlnu = 0.441
 sig_scale_2017 = float(histo_scale.Integral())
 sig_tree_2017.Draw("fathbbjet_deepTagMD_HbbvsQCD>>h_DNN_signal_SB_2017",str(lumi_161718)+"*weight*"+xsbr+"*(Xmass==2000)*"+Cut_SB) # br_WW_qqqq = 0.4544, br_WW_qqlnu = 0.441
 sig_tree_2017.Draw("fathbbjet_deepTagMD_HbbvsQCD>>h_DNN_signal_SR_2017",str(lumi_161718)+"*weight*"+xsbr+"*(Xmass==2000)*"+Cut_SR) # br_WW_qqqq = 0.4544, br_WW_qqlnu = 0.441

 ### HtoGG Bkgs ###
#  ggHtoGG_tree_2017 = ROOT.TChain()
#  ggHtoGG_tree_2017.AddFile(inDir+'/GluGluHToGG_M125.root/ggh_125_13TeV_HHWWggTag_1')
#  ggHtoGG_tree_2017.Draw("fathbbjet_deepTagMD_HbbvsQCD>>h_DNN_ggHtoGG_SR_2017",str(lumi_161718)+"*weight*"+Cut_SR)
#  VBFHtoGG_tree_2017 = ROOT.TChain()
#  VBFHtoGG_tree_2017.AddFile(inDir+'/VBFHToGG_M125.root/vbf_125_13TeV_HHWWggTag_1')
#  VBFHtoGG_tree_2017.Draw("fathbbjet_deepTagMD_HbbvsQCD>>h_DNN_VBFHtoGG_SR_2017",str(lumi_161718)+"*weight*"+Cut_SR)
#  VHtoGG_tree_2017 = ROOT.TChain()
#  VHtoGG_tree_2017.AddFile(inDir+'/VHToGG_M125.root/wzh_125_13TeV_HHWWggTag_1')
#  VHtoGG_tree_2017.Draw("fathbbjet_deepTagMD_HbbvsQCD>>h_DNN_VHtoGG_SR_2017",str(lumi_161718)+"*weight*"+Cut_SR)
#  ttHJetToGG_tree_2017 = ROOT.TChain()
#  ttHJetToGG_tree_2017.AddFile(inDir+'/ttHJetToGG_M125.root/tth_125_13TeV_HHWWggTag_1')
#  ttHJetToGG_tree_2017.Draw("fathbbjet_deepTagMD_HbbvsQCD>>h_DNN_ttHtoGG_SR_2017",str(lumi_161718)+"*weight*"+Cut_SR)
...
#  data_tree_2017.AddFile(inDir+'/Data_2018.root/Data_13TeV_HHWWggTag_1')
 ...
 data_tree_2017.Draw("fathbbjet_deepTagMD_HbbvsQCD>>h_DNN_data_SB_2017",Cut_SB)
 data_tree_2017.Draw("fathbbjet_deepTagMD_HbbvsQCD>>h_DNN_data_SB_2017_diffBins",Cut_SB)
 ...
 bkg_tree_2017.Draw("fathbbjet_deepTagMD_HbbvsQCD>>h_DNN_bkg_SR_2017",str(data_scale_2017/bkg_scale_2017)+"*weight*"+Cut_SR)
 bkg_tree_2017.Draw("fathbbjet_deepTagMD_HbbvsQCD>>h_DNN_bkg_SB_2017_diffBins",str(data_scale_2017/bkg_scale_2017)+"*weight*"+Cut_SB)
 ...
 bkg_tree_2017_bdtWeight.Draw("fathbbjet_deepTagMD_HbbvsQCD>>h_DNN_bkg_SB_weighted_2017","weight*"+Cut_SB)
 bkg_tree_2017_bdtWeight.Draw("fathbbjet_deepTagMD_HbbvsQCD>>h_DNN_bkg_SB_weighted_2017_diffBins","weight*"+Cut_SB)
 bkg_tree_2017_bdtWeight.Draw("fathbbjet_deepTagMD_HbbvsQCD>>h_DNN_bkg_SR_weighted_2017","weight*"+Cut_SR)
