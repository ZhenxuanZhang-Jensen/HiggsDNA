...
void makedatadriveQCD()
{
  ...
  vector<string> gjetfilenames = {
    ...
    "/eos/user/a/atishelm/ntuples/HHWWgg_flashgg/WWZ_SignalTopology_Checks/2017/All_Backgrounds/GJet_Pt-20to40_hadded_MoreVars.root",
    "/eos/user/a/atishelm/ntuples/HHWWgg_flashgg/WWZ_SignalTopology_Checks/2017/All_Backgrounds/GJet_Pt-40toInf_hadded_MoreVars.root"
  };
