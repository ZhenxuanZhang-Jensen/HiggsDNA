...
const TString InputDataFile = "/eos/user/s/shsong/hhwwggSL_root/data/2017data_muon.root";
...
const TString Inputgg40to80File = "/eos/user/s/shsong/hhwwggSL_root/bkg/DiPhotonJetsBoxM40_80_2017_mu.root";
...
const string OutputPlotDir = "/eos/user/s/shsong/DataMCComparisonPlots_mu";
