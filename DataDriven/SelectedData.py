...
path="/eos/user/z/zhenxuan/hhwwgg_root/" 
procs = ["data_UL17cat1"]
component = ["cat1"]

select = ["min(LeadPhoton_mvaID,SubleadPhoton_mvaID)>=-0.9 && min(LeadPhoton_mvaID,SubleadPhoton_mvaID)<= -0.7 && max(LeadPhoton_mvaID,SubleadPhoton_mvaID)>-0.9"]
