...
def MakeTree(inputTree, h_ratio, scale, ouputFile):
 ...
 for i in range(0, nentries):
    ...
    # print("debug: 60")
    # MVA_Score_Branch="inputTree.%s"%("fatjet_H_Hqqqq_qqlv_vsQCDTop")
    MVA_Score_Branch = inputTree.fatjet_H_Hqqqq_qqlv_vsQCDTop
    exec("MVA_Score_Branch = inputTree.%s"%("fatjet_H_Hqqqq_qqlv_vsQCDTop"))
    # print("debug: 61")
 ...
 # for i in range(0, nentries):
    # inputTree.GetEntry(i)
    # if h_ratio.GetBinContent(h_ratio.FindBin(inputTree.fatjet_H_Hqqqq_qqlv_vsQCDTop))!=0.:
        # bdt_weight[0] = scale*float(h_ratio.GetBinContent(h_ratio.FindBin(inputTree.fatjet_H_Hqqqq_qqlv_vsQCDTop)))
    # else: bdt_weight[0] = scale
    # outTree.Fill()
 # outFile.cd()
 # outTree.Write()
...
#  h_DNN_smooth.Scale(h_bdt.Integral()/h_DNN_smooth.Integral())
 print("h_DNN_smooth_rnd.Integral() is : ",h_DNN_smooth_rnd.Integral())
...
def drawHistos(hist,hist_smooth,hist_smooth_up,hist_smooth_down,name):
   ...
   hist.GetXaxis().SetTitle('fatjet_H_Hqqqq_qqlv_vsQCDTop')
...
#  Cut_noMass = '( LeadPhoton_mvaID>-0.7 && Subleading_Photon_MVA>-0.7 && fatjet_H_Hqqqq_qqlv_vsQCDTop>'+str(min)+' && EvalDNN_BBvsAll < 0.6 )'
 Cut_noMass = '( minphotonID>-0.9 && fatjet_H_Hqqqq_qqlv_vsQCDTop>'+str(min)+' )'
#  Cut_SR = '( LeadPhoton_mvaID>-0.7 && Subleading_Photon_MVA>-0.7 && Diphoton_mass>100. && Diphoton_mass<180. && (Diphoton_mass > '+str(massMin)+' && Diphoton_mass < '+str(massMax)+') && fatjet_H_Hqqqq_qqlv_vsQCDTop>'+str(min)+' && EvalDNN_BBvsAll < 0.6 )'
 Cut_SR = '( minphotonID>-0.9 && Diphoton_mass>100. && Diphoton_mass<180. && (Diphoton_mass > '+str(massMin)+' && Diphoton_mass < '+str(massMax)+') && fatjet_H_Hqqqq_qqlv_vsQCDTop>'+str(min)+' )'
#  Cut_SB = '( LeadPhoton_mvaID>-0.7 && Subleading_Photon_MVA>-0.7 && Diphoton_mass>100. && Diphoton_mass<180. && !(Diphoton_mass > 115 && Diphoton_mass < 135) && fatjet_H_Hqqqq_qqlv_vsQCDTop>'+str(min)+'&& EvalDNN_BBvsAll < 0.6  )'
 Cut_SB = '( minphotonID>-0.9 && Diphoton_mass>100. && Diphoton_mass<180. && !(Diphoton_mass > 115 && Diphoton_mass < 135) && fatjet_H_Hqqqq_qqlv_vsQCDTop>'+str(min) + ')'
 ...
 xsbr="1"
 #sig_tree_2017.AddFile(inDir+'/Signal_reweight.root/parquettree')
 sig_tree_2017.AddFile(inDir+'/UL17_R_gghh_M-2400_2017_cat1.root/cat1')
 sig_tree_2017.Draw("LeadPhoton_mvaID<-1.?-1.1:LeadPhoton_mvaID>>histo_scale","weight_central*"+xsbr+"*"+Cut_SR) # br_WW_qqqq = 0.4544, br_WW_qqlnu = 0.441
 #sig_tree_2017.Draw("LeadPhoton_mvaID<-1.?-1.1:LeadPhoton_mvaID>>histo_scale","weight_central*"+xsbr+Cut_SR) # br_WW_qqqq = 0.4544, br_WW_qqlnu = 0.441
 sig_scale_2017 = float(histo_scale.Integral())
 sig_tree_2017.Draw("fatjet_H_Hqqqq_qqlv_vsQCDTop>>h_DNN_signal_SB_2017",str(lumi_161718)+"*weight_central*"+xsbr+"*"+Cut_SB) # br_WW_qqqq = 0.4544, br_WW_qqlnu = 0.441
 sig_tree_2017.Draw("fatjet_H_Hqqqq_qqlv_vsQCDTop>>h_DNN_signal_SR_2017",str(lumi_161718)+"*weight_central*"+xsbr+"*"+Cut_SR) # br_WW_qqqq = 0.4544, br_WW_qqlnu = 0.441

 ### HtoGG Bkgs ###
#  ggHtoGG_tree_2017 = ROOT.TChain()
#  ggHtoGG_tree_2017.AddFile(inDir+'/GluGluHToGG_M125.root/ggh_125_13TeV_HHWWggTag_1')
#  ggHtoGG_tree_2017.Draw("fatjet_H_Hqqqq_qqlv_vsQCDTop>>h_DNN_ggHtoGG_SR_2017",str(lumi_161718)+"*weight_central*"+Cut_SR)
#  VBFHtoGG_tree_2017 = ROOT.TChain()
#  VBFHtoGG_tree_2017.AddFile(inDir+'/VBFHToGG_M125.root/vbf_125_13TeV_HHWWggTag_1')
#  VBFHtoGG_tree_2017.Draw("fatjet_H_Hqqqq_qqlv_vsQCDTop>>h_DNN_VBFHtoGG_SR_2017",str(lumi_161718)+"*weight_central*"+Cut_SR)
#  VHtoGG_tree_2017 = ROOT.TChain()
#  VHtoGG_tree_2017.AddFile(inDir+'/VHToGG_M125.root/wzh_125_13TeV_HHWWggTag_1')
#  VHtoGG_tree_2017.Draw("fatjet_H_Hqqqq_qqlv_vsQCDTop>>h_DNN_VHtoGG_SR_2017",str(lumi_161718)+"*weight_central*"+Cut_SR)
#  ttHJetToGG_tree_2017 = ROOT.TChain()
#  ttHJetToGG_tree_2017.AddFile(inDir+'/ttHJetToGG_M125.root/tth_125_13TeV_HHWWggTag_1')
#  ttHJetToGG_tree_2017.Draw("fatjet_H_Hqqqq_qqlv_vsQCDTop>>h_DNN_ttHtoGG_SR_2017",str(lumi_161718)+"*weight_central*"+Cut_SR)
...
# data_tree_2017.AddFile(inDir+'/Data_reweight.root/parquettree')
 data_tree_2017.AddFile(inDir+'/Data_cat1.root/cat1')
#  data_tree_2017.AddFile(inDir+'/Data_2018.root/Data_13TeV_HHWWggTag_1')
 data_tree_2017 = reduceTree(data_tree_2017,Cut_noMass)
 data_tree_2017.Draw("LeadPhoton_mvaID<-1.?-1.1:LeadPhoton_mvaID>>histo_scale",Cut_SB)
 data_scale_2017 = float(histo_scale.Integral())
 data_tree_2017.Draw("fatjet_H_Hqqqq_qqlv_vsQCDTop>>h_DNN_data_SB_2017",Cut_SB)
 data_tree_2017.Draw("fatjet_H_Hqqqq_qqlv_vsQCDTop>>h_DNN_data_SB_2017_diffBins",Cut_SB)
 ...
 treeNames = [
  ...
  "diphoton_jets_cat1_SFs.root/cat1",
  "DataDriven_data_cat1_SFs.root/cat1",
 ...
 bkg_tree_2017.Draw("LeadPhoton_mvaID<-100?-1.1:LeadPhoton_mvaID>>histo_scale",str(lumi_161718) + "*weight_central*"+Cut_SB)
 # bkg_tree_2017.Draw("LeadPhoton_mvaID>>histo_scale",str(lumi_161718) + "*weight_central*"+Cut_SB)
 bkg_scale_2017 = float(histo_scale.Integral())
 print("bkg_scale_2017: %f"%bkg_scale_2017)
 bkg_tree_2017.Draw("fatjet_H_Hqqqq_qqlv_vsQCDTop>>h_DNN_bkg_SR_2017",str(data_scale_2017/bkg_scale_2017)+"*weight_central*"+Cut_SR)
 bkg_tree_2017.Draw("fatjet_H_Hqqqq_qqlv_vsQCDTop>>h_DNN_bkg_SB_2017_diffBins",str(data_scale_2017/bkg_scale_2017)+"*weight_central*"+Cut_SB)
 ...
 bkg_tree_2017_bdtWeight.Draw("fatjet_H_Hqqqq_qqlv_vsQCDTop>>h_DNN_bkg_SB_weighted_2017","weight_central*"+Cut_SB)
 bkg_tree_2017_bdtWeight.Draw("fatjet_H_Hqqqq_qqlv_vsQCDTop>>h_DNN_bkg_SB_weighted_2017_diffBins","weight_central*"+Cut_SB)
 bkg_tree_2017_bdtWeight.Draw("fatjet_H_Hqqqq_qqlv_vsQCDTop>>h_DNN_bkg_SR_weighted_2017","weight_central*"+Cut_SR)
