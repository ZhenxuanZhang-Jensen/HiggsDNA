...
if __name__ == '__main__':
  ...
  parser.add_option( "-r", "--massMin", dest='massMin',  default=115.0,  type="float",  help="massMin")
  parser.add_option( "-R", "--massMax", dest='massMax',  default=135.0,  type="float",  help="massMax")
  ...
  #1 categories
  if nCats == 1:
   #print("h_bdt_signal_SR",h_bdt_signal_SR)
   #print("h_bdt_datamix_SR_weighted_smooth",h_bdt_datamix_SR_weighted_smooth)
   #print("h_bdt_data_SB",h_bdt_data_SB)
   ...
   #print("h_bdt_signal_SR.GetBinCenter(partition_final[0][0])",h_bdt_signal_SR.GetBinCenter(partition_final[0][0]))
