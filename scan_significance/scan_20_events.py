...
def main():
    ...
    mc_bkg1_scores = mc_bkg1["fatjet_H_Hqqqq_qqlv_vsQCDTop"].array()
    mc_bkg2_scores = mc_bkg2["fatjet_H_Hqqqq_qqlv_vsQCDTop"].array()
    mc_bkg1_weights = mc_bkg1["weight_central"].array()
    mc_bkg2_weights = mc_bkg2["weight_central"].array()
