The golden json files are those recommended in the [SWGuideGoodLumiSectionsJSONFile TWiki](https://twiki.cern.ch/twiki/bin/view/CMSPublic/SWGuideGoodLumiSectionsJSONFile):
